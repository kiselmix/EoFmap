const data = {
            nodes: [
                ...
                {id: 17, x: 100, y: 525, color: 'yellow', active: false, image: 'skill/17.png', video: './skill/Rapid Fire.mp4', description: 'Rapid Fire <br>ACTIVE ABILITY <br>Cooldown: 155 <br>Cost: 50 energy <br>Projectile Damage: 54 Physical <br>Launches multiple bullets into the cursor position. Characters hit with the bullet get Physical DMG.'},
                ...
                {id: 113, x: 650, y: -275, color: 'yellow', active: false, image: 'skill/33.png', video: './skill/Rocket Shower.mp4', description: 'Rocket Shower <br>ACTIVE ABILITY <br>Cooldown: 355 <br>Cost: 45 energy <br>AOE Damage: 111 Physical <br>Launches multiple rockets that deal damage in a large circular area (8m radius). Lasts around 4s.'},
